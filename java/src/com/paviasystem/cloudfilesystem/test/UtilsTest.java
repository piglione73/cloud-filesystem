...
public class UtilsTest {
	...
	public void test_formatTimestamp() {
		assertEquals("1970-01-01T00:00:00.000",
				Utils.formatTimestamp(new Date(0)));
		assertEquals("1970-01-01T00:00:12.345",
				Utils.formatTimestamp(new Date(12345)));
	}

	@Test
	public void test_parseTimestamp() throws ParseException {
		assertEquals(new Date(0),
				Utils.parseTimestamp("1970-01-01T00:00:00.000"));
		assertEquals(new Date(12345),
				Utils.parseTimestamp("1970-01-01T00:00:12.345"));
	}
}
